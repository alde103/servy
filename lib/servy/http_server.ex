defmodule Servy.HttpServer do
   #def server do
   #   #crea un listen socket
   #   {:ok, lSock} = :gen_tcp.listen(5678, [:binary, packet: 0, active: false])
   #   #blocking function (espera hasta que llegue una petición de algún cliente)
   #   {:ok, sock} = :gen_tcp.accept(lSock)
   #   #recibimos todos los datos (argunmento "0")
  ...
  def accept_loop(listen_socket) do
    ...
    # Receives the request and sends a response over the client socket y lo spawneamos como un nuevo proceso
